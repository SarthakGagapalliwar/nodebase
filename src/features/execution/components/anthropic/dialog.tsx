...
import z from "zod";
import { ANTHROPIC_MODELS, FREE_CREDENTIAL_ID } from "@/config/ai-models";
...
interface Props {
  ...
  defalutValues?: Partial<AnthropicFormValues>;
}
...
export const AnthropicDialog = ({
  ...
  const { data: credentials, isLoading: isLoadingCredentials } =
    useCreateCredentialType(CredentialType.ANTHROPIC);
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      model: defalutValues.model || ANTHROPIC_MODELS[0].id,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[85vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Configure the Claude model and prompts for this node. Changes are
            saved automatically.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      {isFreeTier
                        ? "Using free trial"
                        : "Choose the Anthropic credential to use for this node."}
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    The prompt to send to Claude. Use {"{{variables}}"} for
