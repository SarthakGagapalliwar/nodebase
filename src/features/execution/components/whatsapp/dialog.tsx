...
const formSchema = z.object({
  ...
  content: z
    ...
    .max(2000, "WhatsApp message cannot exceed 2000 characters"),
...
interface Props {
  ...
  defalutValues?: Partial<WhatsAppFormValues>;
}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Use the WhatsApp Cloud API endpoint configured for outbound
                    messages.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
