...
export const StriperiggerDialog = ({ open, onOpenChange }: Props) => {
      ...
      <DialogContent>
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-lg bg-muted p-4 space-y-2">
            ...
            <ol className="text-sm text-muted-foreground space-x-1 list-decimal list-inside">
          ...
          <div className="rounded-lg bg-muted p-4 space-y-3">
              ...
              <div className="rounded-lg bg-muted p-4 space-y-2">
                ...
                <ul className="text-sm text-muted-foreground space-y-1">
                    ...
                    <li><code className="bg-background px-1 py-0.5 rounded">{"{{josn stripe}}"}</code> - Full event data as JSON</li>
