...
export const EntityHeader = ({
  ...
  return (
    <div className="flex flex-row items-center justify-between gap-x-4">
      ...
      {newButtonHref && !onNew && (
        <Button size="sm" asChild onClick={onNew}>
...
export const EntityContainer = ({
  ...
  return (
    <div className="p-4 md:px-10 md:py-6 h-full">
      <div className="mx-auto w-full max-w-7xl flex flex-col gap-y-8">
        {header}
...
interface EntityPageinationProps {
  page: number;
  totalPages: number;
